...
- フェーズ 7 残り: 履歴の永続化、アドバイス/ソースのタブ、分割ビュー校正の右パネル寄せ、ノート側からの「再検索して更新」入口。チャット MVP + RAG トグルは 2026-07-08、Web 検索トグル + 資料保存 + 世代履歴は 2026-07-12 実装済み。plan.md フェーズ 7 参照。
